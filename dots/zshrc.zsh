# Says to put zsh-autocomplete at the top of the file
# Don't really need this but it's required to summon the fzf picker for zoxide
...
# Fancy prompt that shows the current git branch
parse_git_branch() {
